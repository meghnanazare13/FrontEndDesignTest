...
window.$ = jQuery;
window.bootstrap = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js"); //require('slick-carousel');
// require('select2');

var teamItems = document.querySelectorAll('.team-carousel .carousel-item');
...
var projectItems = document.querySelectorAll('.project-carousel .carousel-item');
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if ($('.banner-video').length > 0) {
      var bannerPlayer = new Vimeo.Player(document.querySelector('.banner-video'));
      bannerPlayer.play();
      bannerPlayer.setMuted(true);
    }
  });
})($);
